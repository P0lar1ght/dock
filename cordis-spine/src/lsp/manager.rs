...
pub struct LspManager {
    ...
    pub notification_handle: crate::lsp::notify::ToolNotificationHandle,
...
impl Default for LspManager {
    fn default() -> Self {
        Self {
            ...
            shutting_down: false,
            next_lifecycle_id: 1,
            notification_handle: crate::lsp::notify::ToolNotificationHandle::noop(),
            process_scope: None,
        }
    }
}
        ...
        for (name, server_config) in configs {
            ...
            .await
            {
                Ok(mut client) => {
                    ...
                    self.notification_handle
                        .send_lsp_ready(crate::lsp::notify::LspServerReady {
                            server_name: name.clone(),
                        });
