...
mod tests {
    ...
    fn params_on(effort: &str) -> crate::llm::http::WireParams {
        crate::llm::http::WireParams {
            reasoning: crate::llm::http::Reasoning::On,
            effort: effort.into(),
    ...
    fn responses_body_reasoning_is_three_state() {
        ...
        let params = crate::llm::http::WireParams {
            reasoning: crate::llm::http::Reasoning::Unsupported,
            ..params_on("")
        };
        ...
        let params = crate::llm::http::WireParams {
            reasoning: crate::llm::http::Reasoning::Off,
            ..params_on("")
        };
        assert_eq!(
