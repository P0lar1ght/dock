...
async fn send_failed_notification(
    ...
    lsp_manager
        ...
        .await
        .notification_handle
        .send_lsp_failed(crate::tools::lsp::notify::LspServerFailed {
    ...
    loop {
        *attempts += 1;
        ...
        lsp_manager
            ...
            .await
            .notification_handle
            .send_lsp_starting(crate::tools::lsp::notify::LspServerStarting {
                server_name: server_name.to_string(),
...
pub async fn restart_monitor(
    ...
    loop {
        ...
        lsp_manager
            ...
            .await
            .notification_handle
            .send_lsp_crashed(crate::tools::lsp::notify::LspServerCrashed {
        ...
        lsp_manager
            ...
            .await
            .notification_handle
            .send_lsp_retrying(crate::tools::lsp::notify::LspServerRetrying {
                server_name: server_name.clone(),
                attempt: attempts + 1,
                max_restarts,
                backoff_ms: backoff.as_millis() as u64,
