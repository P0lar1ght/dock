...
pub struct LspManager {
    ...
    pub notification_handle: crate::tools::lsp::notify::ToolNotificationHandle,
...
impl Default for LspManager {
    fn default() -> Self {
        Self {
            ...
            shutting_down: false,
            next_lifecycle_id: 1,
            notification_handle: crate::tools::lsp::notify::ToolNotificationHandle::noop(),
            process_scope: None,
        }
    }
}
...
impl LspManager {
    pub fn new(
        ...
        tools_enabled: bool,
        notification_handle: crate::tools::lsp::notify::ToolNotificationHandle,
    ) -> Self {
    ...
    async fn start_configs(&mut self, configs: Vec<(String, LspServerConfig)>) {
        for (name, server_config) in configs {
            ...
            self.notification_handle.send_lsp_starting(
                crate::tools::lsp::notify::LspServerStarting {
            ...
            .await
            {
                Ok(mut client) => {
                    ...
                    self.notification_handle.send_lsp_ready(
                        crate::tools::lsp::notify::LspServerReady {
                            server_name: name.clone(),
                        },
                    );
                ...
                Err(e) => {
                    ...
                    self.notification_handle.send_lsp_failed(
                        crate::tools::lsp::notify::LspServerFailed {
                            server_name: name.clone(),
                            error: e.to_string(),
                            attempts: 0,
                        },
