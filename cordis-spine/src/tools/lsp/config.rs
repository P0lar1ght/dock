...
/// return the [`ConfigSource`](crate::tools::lsp::config_source::ConfigSource) of each.
///
...
pub fn load_servers_with_plugins_sourced(
    ...
    (
        LspServerConfig,
        crate::tools::lsp::config_source::ConfigSource,
    ),
> {
    use crate::tools::lsp::config_source::ConfigSource;
